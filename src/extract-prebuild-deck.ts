...
import { type Deck } from './model/prebuild-deck.js';
import { covertTableToDeck } from './feature/convert-table-to-deck.js';
import { parseUrlDeckName } from './feature/parse-url-deck-name.js';
